  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  w-full gap-4 mx-auto px-8">
        ...
        <Card title="Planning and Design" 
            icon={<AceternityIcon order="Phase1"/>}
            description ="Brainstorming on efficeient planning and designing">
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development and Testing" 
            ...
            description ="Secure Coding Practices and Continuous Testing">
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Deployment and Maintenance with Feedback" 
            icon={<AceternityIcon  order="Phase3"/>}
            description ="Monitoring, Incident Response, and Patch Management">
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = ({order} : {order: string}) => {
  return (
    <div>
        ...
        <div className="font-medium px-8 py-2  bg-grey rounded-[1px]  relative group transition duration-200 text-purple hover:bg-transparent">
            {order}
        </div>
        </button>
    </div>
